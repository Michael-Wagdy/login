    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('agency.offer.create') }}"  enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="start_date" type="text" class="form-control  form_datetime @error('start_date') is-invalid @enderror" name="start_date"  required autocomplete="start_date">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="agency_price" type="number" class="form-control @error('agency_price') is-invalid @enderror" name="agency_price"  required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="user_price" type="number" class="form-control @error('user_price') is-invalid @enderror" name="user_price"  required autocomplete="user_price" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="no_rooms" type="number" class="form-control @error('no_rooms') is-invalid @enderror" name="no_rooms" required autocomplete="no_rooms" autofocus>
                  ...
                  <select class="select2" name="category[]" multiple="category" data-placeholder="Select a State" style="width: 100%;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="Departial_time" type="text" class="form-control  form_datetime @error('start_date') is-invalid @enderror" name="Departial_time[]">
