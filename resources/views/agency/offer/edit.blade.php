                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('agency.offer.update',$offer->id) }}"  enctype="multipart/form-data">
                        ...
                        @endif
                            ...
                            <div class="col-md-8">
                                <input  type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $offer->name }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input  type="text" class="form-control form_datetime @error('start_date') is-invalid @enderror " name="start_date" value="{{ $offer->start_date }}" required autocomplete="start_date">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                            <input  type="text" class="form-control form_datetime @error('end_date') is-invalid @enderror " name="end_date" value="{{ $offer->end_date }}" required autocomplete="end_date">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control @error('agency_price') is-invalid @enderror" name="agency_price" value="{{ $offer->agency_price }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input  type="number" class="form-control @error('user_price') is-invalid @enderror" name="user_price" value="{{ $offer->user_price }}" required autocomplete="user_price" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control @error('no_rooms') is-invalid @enderror" name="no_rooms" value="{{ $offer->no_rooms }}" required autocomplete="no_rooms" autofocus>
                  ...
                  <div class="col-md-8">
                  <select class="form-control select2"  name="category[]" multiple="category" data-placeholder="Select a category">
                  ...
                  @foreach(App\category::all() as $category)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select  class="form-control @error('transportation_mode') is-invalid @enderror" name="transportation_mode[]" value="{{ $details->transportation_mode }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input  type="text" class="form-control form_datetime @error('Departial_time') is-invalid @enderror" name="Departial_time[]" value="{{ $details->Departial_time }}" required autocomplete="Departial_time">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input  type="text" class="form-control  form_datetime @error('arrival_time') is-invalid @enderror " name="arrival_time[]" value="{{$details->arrival_time}}" required autocomplete="arrival_time">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control  @error('to') is-invalid @enderror" name="to[]" value="{{$details->to }}" required autocomplete="to" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control @error('from') is-invalid @enderror" name="from[]" value="{{ $details->from }}" required autocomplete="from" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input   type="number" class="form-control @error('no_trip') is-invalid @enderror" name="no_trip[]" value="{{ $details->no_trip }}" required autocomplete="no_trip" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input  type="file"  accept="image/*" class="form-control @error('photo') is-invalid @enderror" name="photos[]" multiple>
                            </div>  
...
$('#add-details').click(function(){
    ...
    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input  type="text"  class="form-control  form_datetime @error('arrival_time') is-invalid @enderror " name="arrival_time[]" required autocomplete="arrival_time">
