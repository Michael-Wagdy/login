    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('agency.update.profile',$agency->id) }}"  enctype="multipart/form-data">
                        @csrf
                        {{method_field('patch')}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="photo" type="file"  accept="image/*" class="form-control @error('photo') is-invalid @enderror" name="photo"  value="{{$agency->photo}}">
                            </div>  
